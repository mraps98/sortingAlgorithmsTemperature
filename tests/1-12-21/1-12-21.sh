...
FILE_NAME="/home/preet/projects/sortingAlgorithmsTemperature/generating_data/rand100k.dat"
...
for SORT_TYPE in binsertion bubble bubble_rec cocktail comb cycle gnome heap insertion insertion_rec merge mergebu pancake quick radix selection shell tim
do
